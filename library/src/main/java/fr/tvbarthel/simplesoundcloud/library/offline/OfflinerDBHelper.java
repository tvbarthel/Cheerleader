...
import fr.tvbarthel.simplesoundcloud.library.BuildConfig;
...
class OfflinerDBHelper extends SQLiteOpenHelper {
     ...
     * table cache name.
     */
    public static final String TABLE_CACHE = "SOUND_CLOUD_OFFLINE";
    ...
    private static final String DATABASENAME = "soundcloud_offline.db";
